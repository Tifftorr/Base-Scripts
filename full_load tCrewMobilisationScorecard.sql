SELECT
	...
	SUM(Mob.RELIEVER_PLANNED_NXT_30_DAYS) AS [Reliver Planned Next 30 Days],
	SUM(Mob.CREW_ONBOARD_SIGNINGOFF_NXT_30_DAYS) AS [Berths to Plan 30 Days],
	NULL AS [Time Given To Mobilize],
	NULL AS [Flag State Compliant Crew],
	NULL AS [Flag State Onboard Crew]
